...
public class LinqTests : IDisposable
{
    ...
    [Fact]
    public void Compose_Where_OrderBy_Skip_Take()
    {
    ...
    [Fact]
    public void Compose_WhereIf_Mixed()
    {
    ...
    [Fact]
    public void Compose_MultipleWhere()
    {
    ...
    [Fact]
    public void Compose_ThenBy_AfterOrderBy()
    {
